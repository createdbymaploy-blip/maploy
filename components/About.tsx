...
const About: React.FC = () => {
  ...
  // --- QUEEN IMAGE SETTINGS ---
  // Adjust these values to move/resize the Queen in the community card
  // NOW SUPPORTS VALUES > 100% because we added 'max-w-none' to the image
  const queenSettings = {
    width: '194%',        // Scale of the image (increase to make bigger, e.g., 200%)
    left: '44.4%',          // Horizontal anchor point
    bottom: '-10%',       // Vertical position
    transform: 'translateX(-50%)', // Horizontal shift (-50% is center, -60% is more left)
    opacity: 0.2          // Transparency
  };

  return (
    <section id="about" className="py-24 relative z-10 px-5">
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-12 md:gap-[60px] items-start">
        
        {/* Text Content */}
        <div className="text-center md:text-left sticky top-20">
          
          {/* Avatar and Title Row */}
          {/* Changed items-start to items-end to align text to the bottom of the photo */}
          <div className="flex flex-col md:flex-row items-end gap-8 mb-8 w-full">
            {/* Avatar Container */}
            <div className="w-[135px] h-[135px] rounded-full overflow-hidden flex-shrink-0 border-[3px] border-white/10 shadow-2xl relative bg-black">
                <img 
                    ...
                    style={{ 
                        transform: 'translate(-60%, -40%) scale(2.4)' 
                    }}
                />
            </div>
            ...
            <div className="flex flex-col w-full pb-2"> 
                <div className="flex flex-col md:flex-row items-end md:items-end md:justify-between w-full">
                     {/* Increased font size to 4.5rem */}
                     <h2 className="text-[4.5rem] font-medium leading-[0.9]">
                      I’m <em className="font-serif italic text-slate-300">Bulat</em>
                    </h2>
                    
                    {/* Badge */}
                    <div className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 text-sm font-semibold text-slate-300 mt-4 md:mt-0 md:mb-3">
          ...
          <p className="text-lg text-slate-400 leading-[1.7] mb-10 max-w-[600px] mx-auto md:mx-0">
        ...
        {/* Community Stat Card */}
        <div className="relative flex flex-col justify-center h-full max-w-[500px] mx-auto md:mx-0 w-full min-h-[500px]">
            {/* Deep Blue Radial Glow Atmosphere */}
            ...
            <div className="relative z-10 w-full group bg-[#0b1120]/30 backdrop-blur-xl border border-white/10 rounded-3xl p-8 overflow-hidden hover:border-accent/30 transition-colors duration-300 shadow-[inset_0_0_20px_rgba(255,255,255,0.03)] h-[500px] flex flex-col justify-center">
                 ...
                 {/* Queen Image - Integrated as Texture with Controlled Settings */}
                 {/* Added max-w-none to allow it to be larger than 100% of container */}
                 <img 
                 ...
                 {/* Decor Stars floating around the card */}
                 ...
                 <StarIcon className="absolute top-10 right-8 w-2 h-2 text-slate-300 animate-pulse delay-200 z-20" />
                 ...
                 <div className="relative z-20 flex flex-col items-center text-center">
                    ...
                    <div className="mb-8">
                        <div className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60 tracking-tighter drop-shadow-sm">
                            1,160+
                        </div>
